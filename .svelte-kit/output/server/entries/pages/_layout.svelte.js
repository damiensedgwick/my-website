...
import { i as initializeModalStore, p as prefersReducedMotionStore, g as getModalStore } from "../../chunks/ProgressBar.svelte_svelte_type_style_lang.js";
...
const ModalContent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_modalStore = subscribe(modalStore, (value) => $modalStore = value);
  $$unsubscribe_modalStore();
  return `<div class="p-8 rounded-md space-y-4 bg-colour-surface">${$modalStore[0] ? `<header><h2 class="h2 text-center">${escape($modalStore[0].title)}</h2></header> <article><p>${escape($modalStore[0].body)}</p></article> <div class="logo-cloud grid-cols-1 lg:!grid-cols-6 gap-1" data-svelte-h="svelte-10a3q5o"><a class="logo-item bg-gradient-to-br variant-gradient-primary-secondary" href="/"><span>Skeleton</span></a> <a class="logo-item" href="/"><span>Skeleton</span></a> <a class="logo-item" href="/"><span>Skeleton</span></a> <a class="logo-item" href="/"><span>Skeleton</span></a> <a class="logo-item" href="/"><span>Skeleton</span></a> <a class="logo-item" href="/"><span>Skeleton</span></a></div>` : ``}</div>`;
});
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  initializeStores();
  const modalRegistery = { modalComponent: { ref: ModalContent } };
  return `${validate_component(Modal, "Modal").$$render($$result, { components: modalRegistery }, {}, {})} ${slots.default ? slots.default({}) : ``}`;
});
export {
  Layout as default
};
